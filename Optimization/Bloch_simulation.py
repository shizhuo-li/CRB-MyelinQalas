...
def simulate_mwf(fa, gap, prep, parameters, num_acqs):
    ...
    TE1 = prep[0]
    TE2 = prep[1]
    delT_M0_M1_1 = ro_gap[0] - etl - TE1
    delT_M0_M1_2 = ro_gap[1] - etl - TE2
    delT_M2_M3 = etl
    delT_M2_M6 = ro_gap[2]
    delT_M4_M5 = 12.8e-3
    ...
    delT_M6_M7 = etl
    delT_M7_M8 = ro_gap[3] - etl
    delT_M8_M9 = etl
    if num_acqs > 4:
        delT_M9_M10 = ro_gap[4] - etl
        delT_M10_M11 = etl
    if  num_acqs > 5:
        delT_M11_M12 = ro_gap[5] - etl
        delT_M12_M13 = etl
